...
<head>
    ...
    <title>Portal Academico Victoria Estudiante - Amigurumis</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #02b5bd;">
        <div class="container">
            <a class="navbar-brand" style="font-size:2rem !important">Portal Academico Victoria Estudiante - Amigurumis</a><h5 class="mt-4" style="color:#ffe6f0"><?php
...
?></h5>
    ...
    <div class="contenido">
        ...
        <header>
            <h1 class="mt-3" style="text-align:center">Bienvenid@s a Portal Academico Victoria Estudiante - Amigurumis</h1>
        </header>
...
function openWhatsApp(nombreProducto, precioProducto, tamañoProducto, categoriaProducto) {
    ...
    <footer class=" text-center text-lg-start" style="background-color: #02b5bd;">
        <div class="container p-4">
            <p>&copy; Portal Academico Victoria Estudiante - Amigurumis 2025. Todos los derechos reservados.</p>
        </div>
    </footer>
</body>
