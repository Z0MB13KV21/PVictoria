...
<head>
    ...
    <title>Portal Academico Victoria Estudiante - Bolsos</title>
    ...
    <!-- Bootstrap JS and jQuery       <script src="../admin/js/NC.js"></script> -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #02b5bd;">
        <div class="container">
            <a class="navbar-brand" style="font-size:2rem !important">Portal Academico Victoria Estudiante - Bolsos </a><h5 class="mt-4" style="color:#ffe6f0"><?php

// Verificar si existe información del usuario en la sesión
if (isset($_SESSION['usuario'])) {
    $nombre_usuario = $_SESSION['usuario'];
    echo "<p>$nombre_usuario</p>";
} else {
    echo "<p>No hay usuario activo</p>";
}
?></h5>
    ...
    <div class="contenido">
        ...
        <header>
            <h1 class="mt-3" style="text-align:center">Bienvenid@ a Portal Academico Victoria Estudiante - Bolsos</h1>
        </header>
...
<div class="input-group-append" style="display: flex; align-items: center;">
    ...
    <script src="recursos/bolsos.js"></script>
    <script>
...
function openWhatsApp(nombreProducto, precioProducto, tamañoProducto, categoriaProducto) {
    ...
    <footer class=" text-center text-lg-start" style="background-color: #02b5bd;">
        <div class="container p-4">
            <p>&copy; Portal Academico Victoria Estudiante - Bolsos 2025. Todos los derechos reservados.</p>
        </div>
    </footer>
</body>
