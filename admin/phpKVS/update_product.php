...
// Obtener el ID del producto a actualizar, si está disponible
...
// Renombrar la imagen existente solo si el nombre del producto ha cambiado y no se proporciona una nueva imagen
